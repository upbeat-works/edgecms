/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb84be64ea3d50e5317e8e58b76a6e0b)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	LEGAL_CONSENT_RATE_LIMITER: RateLimit;
	BROWSER: BrowserRun;
	...
	RELEASE_VERSION_WORKFLOW: Workflow<Parameters<import("./workers/app").ReleaseVersionWorkflow['run']>[0]['payload']>;
	ROLLBACK_VERSION_WORKFLOW: Workflow<Parameters<import("./workers/app").RollbackVersionWorkflow['run']>[0]['payload']>;
	AI_TRANSLATE_WORKFLOW: Workflow<Parameters<import("./workers/app").AITranslateWorkflow['run']>[0]['payload']>;
	LEGAL_RELEASE_WORKFLOW: Workflow<Parameters<import("./workers/app").LegalReleaseWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "TRUSTED_ORIGINS" | "LEGAL_SIGNING_KEY_ID" | "AUTH_SECRET" | "SESSION_SECRET" | "OPENAI_API_KEY" | "LEGAL_SIGNING_PRIVATE_JWK">> {}
}
