/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0197196e6f7745a095e0e2e2f031cef)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		RELEASE_VERSION_WORKFLOW: Workflow;
		ROLLBACK_VERSION_WORKFLOW: Workflow;
		AI_TRANSLATE_WORKFLOW: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "TRUSTED_ORIGINS" | "AUTH_SECRET" | "ADMIN_SIGNUP_PASSWORD" | "SESSION_SECRET" | "OPENAI_API_KEY">> {}
}
