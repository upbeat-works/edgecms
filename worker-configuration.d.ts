/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d90838e7e5f780e62c6494b96dd982a)
// Runtime types generated with workerd@1.20250617.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CACHE: KVNamespace;
		R2_BUCKET_NAME: "edgecms-media";
		AUTH_SECRET: string;
		BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME" | "AUTH_SECRET" | "BASE_URL" | "ADMIN_SIGNUP_SECRET">> {}
}
